...
public class DifferenceCalculator {
    ...
    protected boolean isCVSFile(String filepath, String filename)
    {
    	...
    	else if ( (filepath.indexOf("CVS") != -1) || (filename.equals("CVS")) ||(filename.contains("__MACOSX")))
		{
			return true;
		}
		else
    ...
    /**
     * Calculates all the differences between pss.request zip files.
     * It builds up the 2 maps of ZipEntries for the pss.request files
     * and then compares them.
     * @param zf1 The first ZipFile to compare
     * @param zf2 The second ZipFile to compare
     * @return All the differences between the pss.request files.
     * @throws java.io.IOException
     */
    ...
    /**
     * Given pss.request Maps of ZipEntries it will generate a Differences of all the
     * differences found between the pss.request maps.
     * @return All the differences found between the pss.request maps
     */
    ...
    /**
     * returns true if the pss.request entries are equivalent in type, name, size, compressed size
     * and time or CRC.
    ...
    /**
     * 
     * @return all the differences found between the pss.request zip files.
     * @throws java.io.IOException
     */
